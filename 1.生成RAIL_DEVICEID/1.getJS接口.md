...
返回的是getJS文件，前端根据getJS计算logdevice接口所需要的所有参数，logdevice接口用于获取RAIL_DEVICEID和RAIL_EXPIRATION两个Cookie的值。

 **备注** 

- 该文件是由12306后台动态生成的，每隔一段时间就会发生变化，包扩函数名、变量名和算法流程。



![公众号二维码](https://tva1.sinaimg.cn/large/007S8ZIlgy1gdy3hdcd6gj3076076gm3.jpg)
